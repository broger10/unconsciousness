      ...
      >
        <div className="text-center mb-10">
          <motion.div
            ...
            className="text-5xl mb-6 text-amber"
          >
            &#9670;
          </motion.div>
        ...
        <div className="glass rounded-2xl p-8 space-y-4">
          ...
          <div className="text-center text-text-muted text-xs font-ui pt-4 space-y-2">
            <p className="flex items-center justify-center gap-1">
              <span className="text-verdigris">&#9670;</span> I tuoi dati restano tuoi. Zero tracking.
            </p>
          </div>
        </div>
      </motion.div>
